...
function makeBook(
  ...
  if (inputBookIsComplete == true) {
    bookIsComplete.innerText = 'Unfinished';
  } else {
    bookIsComplete.innerText = "It's done";
  }
...
function createCompleteButton() {
  return createButton('reading', function (event) {
...
function removeBook(bookElement) {
  ...
  if (window.confirm('Do you want to remove this book from the shelves?')) {
...
function addBookToCompleted(bookElement) {
  ...
  const bookIsComplete = bookElement.querySelector('.reading').innerText;

  if (bookIsComplete == "It's done") {
